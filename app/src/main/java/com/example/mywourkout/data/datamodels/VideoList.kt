...
class VideoList {
  ...
  fun loadMyworkout(): List<Video> {
    return listOf(
      ...
      Video("Yoga Videos 5 min", "2SyGLbXtS68<", "12"),
      Video("Yoga Video 10 min", "7Av1kR5TnIA", "11"),
      Video("Yoga Video 15 min", "dmlicWfwftA", "10"),
      Video("BOP Video 5 min", "yu5-uyQO1Mg", "9"),
      Video("BOP Video 10 min", "W8yVlnW0fZ4", "8"),
      Video("BOP Video 15 min", "2RRArWkRcPc", "7"),
